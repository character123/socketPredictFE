  ...
  methods: {
    ...
    getStockData() {
      ...
      minuteData({stock_code: result}).then(res => {
        ...
        console.log(res)
        if(res.data.code === 0) {
          this.stockItems = res.data.data.items
      ...
      return {
        ...
        series: [
          ...
          },
          {
            name: '周K',
            type: 'line',
            data: this.calculateMA(7, this.echartsDatas),
            smooth: true,
            showSymbol: false,
            lineStyle: {
              width: 1
          ...
          },
          {
            name: '20日线',
            type: 'line',
            data: this.calculateMA(20, this.echartsDatas),
            smooth: true,
            showSymbol: false,
            lineStyle: {
              width: 1
          ...
          },
          {
            name: '月K',
            type: 'line',
            data: this.calculateMA(30, this.echartsDatas),
            smooth: true,
            showSymbol: false,
            lineStyle: {
              width: 1
